...
- **HomeTab card order** is deliberately context-on-top, action-on-bottom for one-handed thumb reach: `BPM|Date tile row → Announcement → Sign-Up card → PrevPaymentReminder`. Don't flip this back without a reason.
