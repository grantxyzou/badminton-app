...
- **Never restate architecture, env vars, deployment topology or conventions in a plan.** They live here and a copy rots: `ROADMAP.md` still carries the dual-deployment table, promotion tags and `deploy-stable.yml`, all deleted 2026-08-25. Link instead.
