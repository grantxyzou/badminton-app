...
import { GET as shareCardGET } from '@/app/api/equipment/share-card/route';
import { GET as fitVerdictGET } from '@/app/api/equipment/fit-verdict/route';
...
const ROUTES: Record<string, Entry> = {
  ...
  'equipment/share-card': GATED,
  'equipment/fit-verdict': GATED,
  recommend: GATED,
...
describe('behaviour of the gated routes', () => {
  ...
  const CASES: Array<[string, Handler, string]> = [
    ...
    ['equipment/share-card', shareCardGET as Handler, 'http://localhost/api/equipment/share-card?name=Lin'],
    ['equipment/fit-verdict', fitVerdictGET as Handler, 'http://localhost/api/equipment/fit-verdict?name=Lin'],
