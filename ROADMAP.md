...
5. **Flag debt** — with one deployment, the two-week clock starts when work ships to production. Ten retired in September 2026 (SETTLE / NAV_RAIL / LEDGER in #295; COMMAND_CENTER, the five SKILL_* and INSIGHT_CARDS after). `check-flag-sync.mjs` lists anything overdue at session start and on any registry edit; KUDOS, PUSH_NOTIFY and VISUAL_FIELDS retired on 09-10; VALUE_HUB_SLICE (09-17) is next.
